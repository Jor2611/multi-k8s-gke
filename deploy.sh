...
kubectl set image deployments/server-deployments server=jorakhachatryan/multi-server:$SHA
kubectl set image deployments/client-deployments client=jorakhachatryan/multi-client:$SHA
kubectl set image deployments/worker-deployments worker=jorakhachatryan/multi-worker:$SHA